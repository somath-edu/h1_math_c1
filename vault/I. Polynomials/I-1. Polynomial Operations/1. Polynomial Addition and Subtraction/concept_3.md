...
다항식 $x^2 - xy + 2y^2 + 3x - y + 5$ 를 $x$에 대하여 내림차순으로 정리했을 때의 $x$의 계수를 구하고, $y$에 대하여 내림차순으로 정리했을 때의 상수항을 구하시오.

### 💡 문제 해결의 열쇠 (풀이 과정)

1. **$x$에 대한 내림차순 정리**:
   $x$ 문자를 기준으로 차수가 높은 항부터 묶어서 정리합니다.
...
2. **$y$에 대한 내림차순 정리**:
   이번에는 $y$ 문자를 기준으로 차수가 높은 항부터 묶어서 정리합니다.

   $$2y^2 + (-x - 1)y + (x^2 + 3x + 5)$$

   이때 $y$가 포함되지 않은 모든 항이 상수항이 되므로, $y$에 대한 상수항은 **$x^2 + 3x + 5$** 입니다.
